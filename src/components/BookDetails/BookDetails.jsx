...
const getDataBook = () => {
  ...
  axios.get(`http://localhost:80/book_app_redux-main/back_end/getDataBooks.php/${id}`)
  .then(response => {
...
const deleteBook = (id) => {
  axios.delete(`http://localhost:80/book_app_redux-main/back_end/books.php/${id}/delete`).then((response)=>{
      console.log(response.data);
      navigate('/book')
